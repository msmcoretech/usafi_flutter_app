...
class _JobDetailScreenState extends State<JobDetailScreen> {
      ...
      leading: GestureDetector(
        ...
        child: Padding(
          ...
          child: CircleAvatar(
            ...
            child: Icon(Icons.arrow_back,color: AppColors.secondary,size: 18,),
          ),
        ),
      ),
      titleSpacing: 0,
  ...
  Widget _jobMetaInfo() {
    return Container(
      ...
      child: Column(
        children: [
          _metaRow(Icons.person_outline_outlined, 'Job role', 'Bar Staff'),
          ...
          Align(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  Icon(Icons.earbuds_outlined, size: 18, color: AppColors.textPrimary),
                  SizedBox(width: 05,),
                  const Text(
                    '3.5 km',
                    style: TextStyle(
